  ...
  return (
    <div style={{ position: 'absolute', inset: 0, overflow: 'hidden', background: '#59b0ff' }}>
      ...
      <div style={{
        ...
        */}
        <div style={{ 
          position: 'absolute', bottom: '35dvh', left: 0, right: 0, zIndex: 3,
        ...
        */}
        <div style={{ 
          position: 'absolute', bottom: '25dvh', left: 0, right: 0, height: '45dvh', zIndex: 4,
          opacity: mounted ? 1 : 0,
        ...
        */}
        <div style={{
          position: 'absolute', bottom: '27dvh', left: '15vw', zIndex: 6,
