...
// ── Single Video Section (Apple-style scroll reveal) ────────────
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver((entries) => {
      ...
      entries.forEach(en => {
        ...
        // Trigger elegant rise animations
  ...
  return (
    ...
    <section ref={secRef} style={{
      ...
      <div ref={tileRef} style={{
        ...
        <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none', boxShadow: 'inset 0 0 0 1px rgba(255,255,255,0.05)', borderRadius: '16px' }} />
...
function ArcSection() {
  ...
  return (
    ...
    <section ref={secRef} style={{ padding: '120px 0', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 16, marginBottom: '80px' }}>

        <div style={{ width: 60, height: 1, background: 'linear-gradient(90deg, transparent, rgba(255,255,255,0.3))' }} />

        <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.75rem', color: 'rgba(255,255,255,0.5)', textTransform: 'uppercase', letterSpacing: '0.3em', fontWeight: 500 }}>
      ...
      <div style={{ position: 'relative', width: '100%', height: '400px' }}>
        ...
        {ARC_CARDS.map((c, i) => (
          ...
          <div key={i} className="arc-card" style={{
            ...
            <div style={{ fontFamily: "'Inter', sans-serif", fontSize: '1.25rem', fontWeight: 600, color: '#FFF', marginBottom: '12px' }}>{c.n}</div>

            <div style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.85rem', color: 'rgba(255,255,255,0.5)', lineHeight: 1.6 }}>{c.d}</div>
